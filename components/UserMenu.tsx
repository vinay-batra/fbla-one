        ...
        {open && (
          ...
          >
            ...
            <div style={{ padding: "6px" }}>
              ...
              {isAdmin && <MenuItem href="/app/admin" icon="mail" label="Email signups" onClick={() => setOpen(false)} />}
            </div>
...
function MenuItem({ href, icon, label, onClick }: { href: string; icon: string; label: string; onClick: () => void }) {
  const icons: Record<string, React.ReactNode> = {
    ...
    mail: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3 7l9 6 9-6" /></svg>,
  };
  return (
