...
**LIVE at [fbla.one](https://fbla.one). Last shipped: v1.5 (June 4, 2026) - audit hardening pass** (no new features; correctness/trust/a11y/security/perf). **Migrations: 0001-0014 in repo, ALL applied + verified live.** New since v1.4 (read this v1.5 block first; the v1.4/v1.3 blocks below are still accurate history):
