...
**LIVE in production at [fbla.one](https://fbla.one).** Last shipped: v1.3 (June 3, 2026) - public AI chat bubble + report-bug flag button + hero redesign. v1.2 - real shield logo, removed Cmd+K palette, Supabase-backed feedback button (migration 0008 - APPLIED + verified live 5/5 via `_feedback_test.mjs`).
